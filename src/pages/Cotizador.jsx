...
export default function Cotizador() {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-b from-slate-100 to-slate-200">
      {/* Encabezado */}
      <div className="sticky top-0 z-20 backdrop-blur-md bg-white/70 border-b border-slate-200 shadow-sm">
      ...
      <div className="max-w-6xl mx-auto px-5 py-6 grid md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2">
          ...
          {cargando ? (
            <div className="text-slate-600 text-center py-10">Cargando servicios...</div>
          ) : (
