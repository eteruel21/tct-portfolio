...
export const catalogo = [
  ...
  // ================================
  {
    ...
    nombre: "Instalación de cámara de seguridad (unidad)",
    unidad: "unidad",
    precio_unit: 150.0,
  },
  {
    id: "sys_cam_kit4",
    categoria: "servicios_especiales",
    nombre: "Kit residencial 4 cámaras + grabación",
    unidad: "sistema",
    precio_unit: 350.0,
  },
  {
    id: "sys_alarma_basic",
    categoria: "servicios_especiales",
    nombre: "Sistema de alarma básico (residencial)",
    unidad: "sistema",
    precio_unit: 300.0,
  },
  {
    ...
    categoria: "servicios_especiales",
    nombre: "Automatización ligera (iluminación + acceso inteligente)",
    unidad: "sistema",
    precio_unit: 500.0,
  },
  {
