...
export async function onRequestPost({ request, env }) {
  ...
  // 💡 Duraciones según tipo de servicio
  const duraciones = {
    "Instalación eléctrica": 120,
    "Mantenimiento": 90,
    "Inspección técnica": 45,
    "Cotización": 30,
    "Otro": 60,
  };
    ...
    <div style="font-family: Arial; padding:0; margin:0;
      ...
      <div style="background:#ffffffdd; border-radius:16px; max-width:600px; margin:auto;">
        ...
        <div style="padding:20px;">
          <p>Hola <strong>${nombre}</strong>, tu cita fue registrada con éxito.</p>
          <p><strong>Fecha:</strong> ${fecha}</p>
          <p><strong>Hora:</strong> ${hora}</p>
          <p><strong>Dirección:</strong> ${direccion || "—"}</p>
          <p><strong>Motivo:</strong> ${motivo || "—"}</p>
          <p><strong>Técnico asignado:</strong> ${tecnico}</p>
          <p><strong>Código:</strong> <b>${codigo}</b></p>
    ...
    <div style="background:#ffffff; border-radius:16px; max-width:620px; margin:auto; overflow:hidden; box-shadow:0 4px 15px rgba(0,0,0,0.1);">
      ...
      <div style="padding:25px; color:#333;">
        ...
        <table style="width:100%; border-collapse:collapse; margin:15px 0;">
          ...
          <tr><td><strong>Técnico:</strong></td><td>${tecnico}</td></tr>
          ...
          <tr><td><strong>Código:</strong></td><td><b>${codigo}</b></td></tr>
        </table>
